...
namespace cufftdx {
    namespace detail {
        ...
        class fft_thread_execution: public fft_execution<Operators...>
        {
            ...
            template<class FFT>
            friend typename FFT::host_workspace_type cufftdx::make_workspace();
        ...
        protected:
            ...
            static_assert(valid_size_for_bluestein_sm87,
                          "Block execution for this size is not supported");
            ...
            static_assert(valid_size_for_bluestein_sm89,
                          "Block execution for this size is not supported");
            ...
            static_assert(valid_size_for_bluestein_sm90,
                          "Block execution for this size is not supported");
        ...
        private:
            ...
            using fft_thread_execution_type =
                typename CUFFTDX_STD::conditional<is_complete_fft<operator_wrapper_type>::value,
                                                  ...
                                                  fft_thread_execution_partial<Operators...>>::type;
#else
            ...
            using execution_type   = typename CUFFTDX_STD::conditional<has_block_operator,
                                                            ...
                                                            fft_thread_execution_type>::type;
